...
/* GarudaESE NOTE (2026-07-09): this file is DELIBERATELY NOT REGISTERED in
 * nbproject/configurations.xml — it does not compile on the dsPIC33AK256MC506
 * (DAC3CON bitfield model differs from the MC510: no CBE/FLTREN/CMPSTAT).
 * It is MCLV/MC510-specific CMP3 bus-OC hardware code; this board's hardware
 * OC layer is the ATA6847 (ILIM + SCPCR) instead. If a CMP-based limiter is
 * ever wanted here, rewrite against the MC506 DAC/CMP register model — do not
 * just re-add this file to the project. */
#include <xc.h>
#include <stdint.h>
#include <stdbool.h>
