 ...
 * All channels trigger on PG1TRIGA (TRG1SRC=4 = PWM1 Trigger 1 (MC510 bench-proven; common AK table). 2026-07-10: code 5 gave ALL-ZERO telemetry on the board -- 5 is PWM1 Trigger 2 (the ref-FW pairs 5 with ADTR2EN, confirming). TRIGA is routed to BOTH trigger events in hal_pwm as a hedge).
